...
Function four translates a character vector of RNA codons into a protein sequence using the standard codon table.

There is one parameter in this function:

1.  **codons** – A character vector containing RNA codons (each a 3-letter string, e.g., `"AUG"`, `"UUU"`).

The function will return a character string representing the translated amino acid sequence in the one-letter amino acid code.
